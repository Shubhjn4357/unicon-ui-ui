...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle, SheetTrigger } from "@unicorn-ui/ui"
...
import { BentoGrid, BentoCard } from "@unicorn-ui/ui"
    ...
    return (
        <Accordion
            ...
            items={[
                ...
                { id: "item-2", title: "Is it styled?", content: "Yes. It comes with default styles that matches the other components' aesthetic." },
                { id: "item-3", title: "Is it animated?", content: "Yes. It's animated by default, but you can disable it if you prefer." },
            ]}
        />
    )
}
...
export function ToastDemo() {
    ...
    return (
        <Button onClick={() => addToast({ title: "Scheduled: Catch up", description: "Friday, February 10, 2023 at 5:57 PM" })}>
            Add to calendar
        </Button>
    )
}
        ...
        <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[20rem]">
            {[1, 2, 3, 4].map((i) => (
                <BentoCard
                    ...
                    background={<div className="flex flex-1 w-full h-full min-h-24 rounded-xl bg-linear-to-br from-neutral-200 dark:from-neutral-900 dark:to-neutral-800 to-neutral-100" />}
...
export function AnimatedListDemo() {
    return (
        <div className="relative flex h-[300px] w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
            <AnimatedList>
                {[1, 2, 3].map((item) => (
                    <div key={item} className="bg-white dark:bg-neutral-800 p-4 rounded-lg shadow-sm mb-2 w-64">
                        Item {item}
                    </div>
                ))}
            </AnimatedList>
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2">
                <Button onClick={() => setTheme("light")} variant="outline">Light</Button>
                <Button onClick={() => setTheme("dark")} variant="outline">Dark</Button>
            </div>
        </div>
    )
}
    ...
    return (
        <div className="p-4 border rounded bg-muted/50 text-center flex flex-col items-center gap-2">
            ...
            <div className="flex gap-4">
                ...
                <span className="p-2 border rounded">X: <motion.span>{x}</motion.span></span>
                <span className="p-2 border rounded">Y: <motion.span>{y}</motion.span></span>
            </div>
        </div>
    )
}
...
export function MagicCardDemo() {
    return (
        <div className="flex h-[300px] w-full flex-col gap-4 lg:h-[250px] lg:flex-row">
            <MagicCard className="cursor-pointer flex-col items-center justify-center shadow-2xl whitespace-nowrap text-4xl" spotlightColor="#D9D9D955">
                Magic
            </MagicCard>
            <MagicCard className="cursor-pointer flex-col items-center justify-center shadow-2xl whitespace-nowrap text-4xl" spotlightColor="#D9D9D955">
                Card
...
export function DotPatternDemo() {
    return (
        <div className="relative flex h-[300px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
            <DotPattern width={20} height={20} cx={1} cy={1} cr={1} className="mask-gradient(to_bottom_right,white,transparent,transparent) " />
            <span className="pointer-events-none whitespace-pre-wrap bg-linear-to-b from-black to-gray-300/80 bg-clip-text text-center text-8xl font-semibold leading-none text-transparent dark:from-white dark:to-slate-900/10">
                Dot Pattern
            </span>
        </div>
