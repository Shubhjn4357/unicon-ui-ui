...
const Table = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { className: cn("relative w-full overflow-auto rounded-xl border border-neutral-200 dark:border-neutral-800", "unicorn-card" // Table container gets card styling
    ), children: _jsx("table", { ref: ref, className: cn("w-full caption-bottom text-sm text-left", className), ...props }) })));
Table.displayName = "Table";
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (_jsx("thead", { ref: ref, className: cn("[&_tr]:border-b bg-muted/50", className), ...props })));
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (_jsx("tr", { ref: ref, className: cn("border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted border-border", className), ...props })));
